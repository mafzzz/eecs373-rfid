...
*Created by Actel MSS_ACE Configurator Tue Apr 05 15:40:58 2011
*
*/
...
*---------------------------------------------------------------------------*/
/* Names*/
const uint8_t g_ace_channel_0_name[] = "TEMP_INPUT";
...
ace_procedure_desc_t g_sse_sequences_desc_table[ACE_NB_OF_SSE_PROCEDURES] = 
{
	...
	},
	{
        ...
        402,                                                /* uint16_t sse_loop_pc */
        400,                                                /* uint16_t sse_load_offset */
